...
<body>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					<h2>企业注册</h2>
					<form class="form-horizontal" action="/Admin/Regist" method="post">
						<fieldset>

							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="username" id="username1" type="text" placeholder="请输入用户名"/>
							</div>
							...
							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="gsm" id="gsm" type="text" placeholder="请输入公司名称"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="frdb" id="frdb" type="password" placeholder="法人代表"/>
							</div>
							<div class="clearfix"></div>
					...
					<hr>
					<p>
						已有账号点击<a href="/Admin/Login">登录</a>
					</p>	
				</div><!--/span-->
			</div><!--/row-->
